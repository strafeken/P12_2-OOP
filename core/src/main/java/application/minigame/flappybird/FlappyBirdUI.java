...
/**
 * Handles UI rendering for FlappyBirdGame.
 */
public class FlappyBirdUI extends MiniGameUI {
    private int score = 0;
    ...
    protected void drawReadyStateInstructions(SpriteBatch batch, int centerX, int centerY) {
        textManager.draw(batch, "Press SPACE to flap", centerX - 120, centerY - 30, INSTRUCTION_COLOR);
        textManager.draw(batch, "Avoid the pipes!", centerX - 90, centerY - 60, INSTRUCTION_COLOR);
        //textManager.draw(batch, "+10 points per pipe", centerX - 100, centerY - 90, SCORE_COLOR);
    }
    ...
    protected void drawPlayingUI(SpriteBatch batch, float gameTime) {
        ...
        //System.out.println("FlappyBirdUI.drawPlayingUI - score: " + score + ", gameTime: " + gameTime);
    ...
    public void setScore(int score) {
        System.out.println("FlappyBirdUI.setScore(" + score + ") - Old score: " + this.score);
        this.score = score;
        System.out.println("FlappyBirdUI - Score updated: " + score); // Debug output
    }
